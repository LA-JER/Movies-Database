...
# get column names in df
column_names <- names(movie_clean)
...
for (column_name in column_names) {
  ...
  # Replace the "\N" values in the col column of the df data frame with the NA value
  movie_clean$column_name <- gsub("\\\\N", NA, movie_clean$column_name)
  
  # # count missing values
  # n_missing_values <- sum(is.na(movie_clean[[column_name]]))
  # 
  # # Store in dic
  # missing_values_per_column[[column_name]] <- n_missing_values
}
